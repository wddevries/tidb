...
func TestToInt(t *testing.T) {
	tests := []struct {
		...
		{"18446744073709551615", 9223372036854775807, ErrDataOutOfRange},
		{"-1", -1, nil},
		{"1", 1, nil},
		{"-1.23", -1, ErrTruncated},
		{"-9223372036854775807", -9223372036854775807, nil},
		{"-9223372036854775808", -9223372036854775808, nil},
		{"9223372036854775808", 9223372036854775807, ErrDataOutOfRange},
		{"-9223372036854775809", -9223372036854775808, ErrDataOutOfRange},
	}
	for _, tt := range tests {
		var dec MyDecimal
...
func TestToUint(t *testing.T) {
	tests := []struct {
		...
		{"18446744073709551616", 18446744073709551615, ErrDataOutOfRange},
		{"-1", 0, ErrDataOutOfRange},
		{"1.23", 1, ErrTruncated},
		{"9999999999999999999999999.000", 18446744073709551615, ErrDataOutOfRange},
	}
	for _, tt := range tests {
		var dec MyDecimal
		err := dec.FromString([]byte(tt.input))
...
func TestToBinFromBin(t *testing.T) {
	...
	tests := []tcase{
		...
		{"111111111.11", 10, 2, "11111111.11", ErrDataOutOfRange},
		{"000000000.01", 7, 3, "0.010", nil},
		{"123.4", 10, 2, "123.40", nil},
		{"1000", 3, 0, "0", ErrDataOutOfRange},
		{"0.1", 1, 1, "0.1", nil},
...
func TestMulMyDecimal(t *testing.T) {
	...
	tests := []tcase{
		...
		{"1" + strings.Repeat("0", 60), "1" + strings.Repeat("0", 60), "0", ErrDataOutOfRange},
...
func TestShiftMyDecimal(t *testing.T) {
	...
	tests = []tcase{
		...
		{".000000000123", 28, "0.000000000123", ErrDataOutOfRange},
		...
		{"123456789.987654321", 10, "123456789.987654321", ErrDataOutOfRange},
...
func TestFromStringMyDecimal(t *testing.T) {
	...
	tests := []tcase{
		...
		{"123E5", "12300000", nil},
		{"123E-2", "1.23", nil},
		{"1e1073741823", "999999999999999999999999999999999999999999999999999999999999999999999999999999999", ErrDataOutOfRange},
		{"-1e1073741823", "-999999999999999999999999999999999999999999999999999999999999999999999999999999999", ErrDataOutOfRange},
	...
	wordBufLen = 1
	tests = []tcase{
		{"123450000098765", "98765", ErrDataOutOfRange},
